<template>
  <div class="min-h-screen bg-white">
    ...
    <a
      ...
      class="fixed right-4 md:right-6 md:bottom-6 bottom-32 z-40 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 md:p-4 shadow-lg flex items-center justify-center transition-transform transform hover:scale-105"
